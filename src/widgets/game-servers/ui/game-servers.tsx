...
import { GameServerCard } from "@/entities/server-card";

import { useGameServers } from "@/shared/hooks/use-servers";
import { ProfileExtendedBaseEntity } from "@/shared/api/contracts";

import { GameServersSkeleton } from "./game-servers-skeleton";
