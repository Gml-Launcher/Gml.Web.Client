  ...
  return (
    <>
      <div className="flex gap-x-3 items-center">
        <span
          className={`flex items-center justify-center min-w-3 min-h-3 max-w-3 max-h-3 rounded-full after:rounded-full after:min-w-5 after:min-h-5 ${stateColorMap[state]} after:opacity-30 after:${stateColorMap[state]}`}
        ></span>
        <span
          className={`absolute items-center justify-center min-w-3 min-h-3 max-w-3 max-h-3 rounded-full after:rounded-full after:min-w-5 after:min-h-5 ${stateColorMap[state]} animate-ping after:opacity-30 after:${stateColorMap[state]}`}
        ></span>
