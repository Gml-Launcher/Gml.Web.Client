      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-y-4 w-full lg:w-[58rem]">
          ...
          <div className="flex flex-col gap-y-4 rounded-lg border p-4">
            <h3 className="text-lg font-semibold border-b pb-2">Общие</h3>
          ...
          {/* Ошибки */}
          <div className="flex flex-col gap-y-4 rounded-lg border p-4">
            <h3 className="text-lg font-semibold border-b pb-2">Ошибки</h3>
            <div className="flex flex-col gap-y-4 gap-x-8">
              <FormField
                control={form.control}
          ...
          {/* Текстуры */}
          <div className="flex flex-col gap-y-4 rounded-lg border p-4">
            <h3 className="text-lg font-semibold border-b pb-2">Текстуры</h3>
            <div className="flex flex-col gap-y-4 gap-x-8">
          ...
          {/* Хранилище */}
          <div className="flex flex-col gap-y-4 rounded-lg border p-4">
            <h3 className="text-lg font-semibold border-b pb-2">Хранилище</h3>
            <div className="flex flex-col gap-y-4 gap-x-8">
          ...
          {/* API-ключи */}
          <div className="flex flex-col gap-y-4 rounded-lg border p-4">
            <h3 className="text-lg font-semibold border-b pb-2">API-ключи</h3>
            <div className="flex flex-col gap-y-4 gap-x-8">
              <div className="flex flex-row items-center justify-between w-full">
                <div className="flex flex-col gap-y-1 w-1/2">
                  <div className="flex flex-row items-center gap-x-1 mb-2">
